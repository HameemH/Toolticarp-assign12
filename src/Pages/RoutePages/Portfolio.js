...
const Portfolio = () => {
    return (
        <div className='h-screen flex justify-center bg-slate-200 items-center'>
            <div className="card lg:w-96 bg-slate-500 border border-lime-300 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title">Hameem Hossain</h2>
                    <h2 className="card-title">hamimhossain670@gmail.com</h2>
                    <h2 className="card-title">Education: HSC</h2>
                    <h2 className="card-title">Skills: HTML| CSS | JavaScript | REACT JS | NODE | MONGO DB | Express JS | Bootstrap | Tailwind CSS</h2>
